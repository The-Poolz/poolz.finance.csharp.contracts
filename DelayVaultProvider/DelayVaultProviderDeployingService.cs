...
{
    public partial class DelayVaultProviderDeployingService<TContractType>
        where TContractType : Enum
    {
        public IChainProvider<TContractType> ChainProvider { get; }

        public DelayVaultProviderDeployingService(IChainProvider<TContractType> chainProvider)
        {
