...
namespace poolz.finance.csharp.contracts.LockDealNFT
{
    public partial class LockDealNFTDeployingService
    {
        ...
        public virtual Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(long chainId, LockDealNFTDeployment lockDealNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public virtual Task<string> DeployContractAsync(long chainId, LockDealNFTDeployment lockDealNFTDeployment)
        {
            var web3 = ChainProvider.Web3(chainId);
