...
using poolz.finance.csharp.TemporaryToken.ContractDefinition;

namespace poolz.finance.csharp.TemporaryToken
{
    public partial class TemporaryTokenService
    {
        ...
        public TemporaryTokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public TemporaryTokenService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
